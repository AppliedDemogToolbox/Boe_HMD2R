...
#   
#   myname<- "your HMD username"	 ## your registered HMD username / email address
...
#   
#   ## loop example
#   flifetables <-vector("list",nrow(countries))
#   names(flifetables)<- countries$CCode
#   
#   for( i in seq(flifetables)){
#     t.ans <- HMD2R(CNTRY=names(flifetables)[i], myname, mypass, "fltper_1x1")
